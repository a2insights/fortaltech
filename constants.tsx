...
export const SOFTWARE_SYSTEMS: SoftwareSystem[] = [
  {
    ...
    description:
      'Sistema de vendas ultrarápido com emissão de nota fiscal e integração com balanças para o varejo cearense.',
  ...
  },
  {
    ...
    description:
      'Controle automatizado de inventário inteligente para depósitos e centros de distribuição.',
  ...
  },
  {
    ...
    description:
      'Plataforma centralizada para controle de ambientes automatizados e consumo energético.',
  ...
  },
  {
    title: 'BI & Analytics',
    description:
      'Visualize dados de performance em tempo real. O cérebro digital da sua empresa.',
...
export const MEGA_MENU_PROJECTS: MegaMenuItem[] = [
  {
    ...
    description:
      'Nossa unidade de desenvolvimento focada em software sob medida e inovação digital.',
  ...
  },
  {
    ...
    description:
      'Soluções inteligentes para automação de processos, integração de dados e dashboards.',
    link: 'systems',
    isExternal: false,
  },
  {
    ...
    description:
      'Estratégia digital e adequação LGPD para profissionalizar sua infraestrutura.',
    link: 'consultancy',
    isExternal: false,
  },
];
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt:
      'Descubra como a integração de IA e novos protocolos como Matter estão mudando as residências de alto padrão na capital cearense.',
...
export const SERVICES: DetailedService[] = [
  {
    ...
    description:
      'Conforto e sofisticação: controle luzes, ar, cortinas e áudio por voz ou app.',
    items: [
      'Cenas de Iluminação',
    ...
    fullDescription:
      "Solução de elite para residências de alto padrão na Grande Fortaleza. Integramos sistemas complexos de iluminação RGB/Dimerizável, climatização de precisão e áudio multiroom high-fidelity em uma interface única e intuitiva. Nossa engenharia foca na criação de 'Cenários de Vida' que se adaptam à rotina do usuário, garantindo uma economia energética de até 25% através do gerenciamento inteligente de presença e luminosidade natural.",
    benefits: [
      'Conforto absoluto e personalização',
      'Valorização imobiliária imediata (15%+)',
      'Segurança perimetral inteligente',
      'Gestão energética avançada',
    ],
    technicalSpecs: [
      'Protocolos Zigbee/Z-Wave/KNX',
      'Interfaces Touch em Vidro Temperado',
      'Integração Nativa Alexa/Google/Siri',
      'Sistemas de Som Wireless Hi-Res',
    ],
    workflow: [
      'Consultoria de Estilo e Necessidades',
      'Projeto Executivo de Automação',
      'Instalação Técnica e Lançamento de Rede',
      'Calibração e Programação de Cenas',
    ],
    sectors: [
      {
        title: 'Residencial Premium',
        icon: <Home />,
        description: 'Mansões e Coberturas de alto luxo.',
      },
      {
        title: 'Home Cinema',
        icon: <Music />,
        description: 'Salas de entretenimento imersivo.',
      },
    ],
    applications: [
      {
        title: 'Gestão Remota',
        description: 'Controle total da casa via App de qualquer lugar.',
      },
      {
        title: 'Rotinas',
        description: "Cenas automáticas: 'Bom dia', 'Festa' ou 'Viagem'.",
      },
    ],
  },
  {
    ...
    description:
      'Gestão inteligente de energia e ambientes para escritórios, clínicas e varejo.',
    items: [
    ...
    benefits: [
      'Redução auditada de custos fixos (até 40%)',
      'Monitoramento centralizado via Cloud Dashboard',
      'Aumento da vida útil de equipamentos de AC',
      'Conformidade com padrões ESG',
    ],
    technicalSpecs: [
      'Controladores CLP Industriais',
      'Atuadores de Carga de Alta Potência',
      'Protocolos de Comunicação RS485/IP',
      'Plataforma SaaS de Monitoramento',
    ],
    workflow: [
      'Auditoria Energética Preliminar',
      'Design de Malha de Controle',
      'Retrofit ou Instalação Nova',
    ...
    sectors: [
      {
        title: 'Varejo',
        icon: <Store />,
        description: 'Supermercados e Shopping Centers.',
      },
      {
        title: 'Saúde',
        icon: <Activity />,
        description: 'Clínicas e Hospitais inteligentes.',
      },
    ],
    applications: [
      {
        title: 'Energy Dashboard',
        description: 'Visualização em tempo real do consumo.',
      },
      {
        title: 'Smart Scheduling',
        description: 'Agendamento inteligente de climatização.',
      },
    ],
  },
  {
    ...
    description:
      'Som ambiente multiroom e salas de videoconferência de alta performance.',
    ...
    benefits: [
      'Comunicação corporativa impecável',
      'Atmosfera de marca envolvente para varejo',
      'Eliminação de cabos visuais e bagunça técnica',
      "Operação simplificada 'One-Touch'",
    ],
    technicalSpecs: [
      'Matrizes de Vídeo 4K/60Hz',
      'Processadores de Áudio Digital (DSP)',
      'Microfonia de Teto com Beamforming',
      'Displays Profissionais de Alto Brilho',
    ],
    workflow: [
      'Cálculo de Cobertura Acústica',
      'Projeto de Roteamento de Sinal',
      'Instalação de Displays e Caixas',
      'Equalização Ambiental Profissional',
    ],
    sectors: [
      {
        title: 'Hospitalidade',
        icon: <Music />,
        description: 'Hotéis, Bares e Restaurantes.',
      },
      {
        title: 'Educação',
        icon: <Tv />,
        description: 'Auditórios e Salas de Treinamento.',
      },
    ],
    applications: [
      {
        title: 'Video Wall',
        description: 'Exibição de dados e publicidade em larga escala.',
      },
      {
        title: 'Videoconferência',
        description: 'Sistemas integrados Zoom/Teams/Meet.',
      },
    ],
  },
  {
    ...
    description:
      'Segurança avançada com biometria, reconhecimento facial e portaria inteligente.',
    items: [
      'Facial & Biometria',
      'Fechaduras Digitais',
      'Tags & QR Codes',
    ...
    fullDescription:
      "O estado da arte em segurança perimetral e interna. Implementamos reconhecimento facial com detecção de 'liveness' (vida), garantindo que fotos ou vídeos não burlem o sistema. Integramos fechaduras eletromecânicas de alta segurança a softwares de RH para controle automático de jornada e restrição de áreas críticas, tudo com redundância de energia para operação ininterrupta.",
    benefits: [
      'Rastreabilidade total de fluxos',
      'Redução de custos com vigilância física',
      'Eliminação total de chaves e perdas',
      'Integração direta com ERP/RH',
    ],
    technicalSpecs: [
      'Câmeras de Reconhecimento Facial 3D',
      'Leitores Biométricos Ópticos/Capacitivos',
      'Eletroímãs de 600kgf',
      'Bancos de Dados SQL Encriptados',
    ],
    workflow: [
      'Análise de Vulnerabilidade de Acessos',
      'Instalação de Hardwares de Bloqueio',
      'Setup de Servidores e Banco de Dados',
    ...
    sectors: [
      {
        title: 'Corporativo',
        icon: <Building2 />,
        description: 'Prédios e escritórios compartilhados.',
      },
      {
        title: 'Logística',
        icon: <Lock />,
        description: 'Controle de acesso a galpões.',
      },
    ],
    applications: [
  ...
  },
  {
    ...
    description:
      'Projeto 360°: Redes, Wi-Fi para coletores e racks estruturados para checkout.',
    items: [
      'Redes Cabeadas',
      'Wi-Fi Industrial',
      'Checkout Seguro',
    ...
    fullDescription:
      'Projetamos a fundação tecnológica de empresas em crescimento. Nossas Redes PME garantem que a internet nunca seja um gargalo para as vendas. Focamos em cabeamento estruturado certificado e Wi-Fi de alta densidade capaz de suportar centenas de dispositivos simultâneos, desde terminais de caixa até smartphones de clientes, mantendo segurança lógica via segregação de redes (VLANs).',
    benefits: [
      'Estabilidade total de vendas (Uptime 99.9%)',
      'Escalabilidade para novos terminais',
      'Ambiente técnico organizado e limpo',
      'Segurança contra ataques cibernéticos',
    ],
    technicalSpecs: [
      'Cabeamento Cat6/Cat6a GigaBit',
      'Switches Gerenciáveis L3',
      'Firewalls de Próxima Geração (NGFW)',
      'Wi-Fi 6 Enterprise-Grade',
    ],
    workflow: [
      'Survey de Campo e Site Survey',
      'Lançamento e Identificação de Pontos',
      'Certificação de Rede com Fluke',
      'Ativação de Gateways e Segurança',
    ],
    sectors: [
      {
        title: 'Comércio',
        icon: <ShoppingCart />,
        description: 'Lojas, Farmácias e Mercados.',
      },
      {
        title: 'Serviços',
        icon: <Briefcase />,
        description: 'Agências e Escritórios Contábeis.',
      },
    ],
    applications: [
  ...
  },
  {
    ...
    description:
      'Gestão de frotas com bloqueio remoto e análise de combustível na RMF.',
    items: [
      'Rastreamento GPS',
      'Bloqueio via App',
      'Controle de Consumo',
    ...
    fullDescription:
      'Transformamos veículos em unidades de dados inteligentes. Nossa telemetria avançada permite o monitoramento de comportamento do motorista (freadas bruscas, excesso de velocidade), controle de jornada de motoristas e integração com o computador de bordo para leitura de consumo real de combustível. Essencial para operações logísticas que buscam reduzir custos operacionais e aumentar a segurança de ativos na RMF.',
    benefits: [
      'Recuperação imediata em caso de roubo',
      'Economia de combustível via otimização de rotas',
      'Redução de acidentes e multas',
      'Relatórios gerenciais automáticos',
    ],
    technicalSpecs: [
      'Módulos GPS de Alta Sensibilidade',
      'Integração CAN-BUS / OBDII',
      'Conectividade Multicarrier (4G/5G)',
      'Alertas via Webhook / Push',
    ],
    workflow: [
      'Dimensionamento de Hardware por Veículo',
      'Instalação Oculta com Antifurto',
      'Configuração de Plataforma e Alertas',
      'Treinamento do Gestor de Frota',
    ],
    sectors: [
      {
        title: 'Logística',
        icon: <Truck />,
        description: 'Distribuidoras e Transportadoras.',
      },
      {
        title: 'Serviços Urbanos',
        icon: <Car />,
        description: 'Empresas com equipes de rua.',
      },
    ],
    applications: [
      {
        title: 'Cerca Eletrônica',
        description: 'Alerta ao sair de áreas permitidas.',
      },
      {
        title: 'Ranking de Motoristas',
        description: 'Incentivo à condução segura.',
      },
    ],
  },
  {
    ...
    description:
      'Contratos de manutenção para manter os computadores da sua empresa sempre rápidos.',
    items: [
      'Assistência Remota',
      'Manutenção Física',
      'Backup Automático',
    ...
    fullDescription:
      'Atuamos como o seu departamento de tecnologia terceirizado. Oferecemos suporte proativo, antecipando falhas de hardware e software antes que elas interrompam sua operação. Nossos planos incluem gerenciamento de servidores, suporte help-desk para usuários e políticas rigorosas de backup em nuvem, garantindo a continuidade do negócio em qualquer incidente técnico.',
    benefits: [
      'Fim dos custos inesperados com TI',
      'Atendimento prioritário (SLA de até 4h)',
      'Expertise multidisciplinar disponível',
      'Segurança de dados corporativos',
    ],
    technicalSpecs: [
      'Gestão de Inventário de TI',
      'Monitoramento de Saúde de Servidores',
      'Suporte a Windows/Linux/Mac',
      'Antivírus Gerenciado (EDR)',
    ],
    workflow: [
      'Auditoria Inicial e Diagnóstico',
      'Limpeza Técnica e Padronização',
      'Implantação de Agentes de Suporte',
      'Rotina de Visitas Preventivas',
    ],
    sectors: [
      {
        title: 'Contabilidade',
        icon: <FileSpreadsheet />,
        description: 'Sistemas fiscais sempre online.',
      },
      {
        title: 'Jurídico',
        icon: <ShieldAlert />,
        description: 'Proteção de arquivos sensíveis.',
      },
    ],
    applications: [
  ...
  },
  {
    ...
    description:
      'Câmeras IP Full HD com acesso remoto e inteligência artificial de movimento.',
    items: ['Câmeras 4K', 'Acesso Celular', 'Alertas IA', 'Gravação Cloud'],
    fullDescription:
      'Vigilância inteligente baseada em Inteligência Artificial. Nossos sistemas detectam automaticamente intrusões, abandono de objetos e placas veiculares. Utilizamos tecnologia IP PoE para garantir estabilidade de sinal e gravação redundante em local físico e nuvem. O monitoramento pelo smartphone é fluido e permite notificações em tempo real apenas para eventos reais de segurança.',
    benefits: [
      'Visão noturna colorida (Full Color)',
      'Redução de falsos alarmes via IA',
      'Acesso remoto de alta performance',
      'Documentação legal em alta definição',
    ],
    technicalSpecs: [
      'Câmeras com IA AcuSense/DeepinMind',
      'Compressão H.265+ (Economia de HD)',
      'Alimentação PoE Industrial',
      'Storage em Nuvem AWS S3',
    ],
    workflow: [
      'Estudo de Pontos Cegos e Iluminação',
      'Instalação de Infra e Cabeamento',
      'Setup de NVR e Inteligência',
      'Configuração de App nos Smartphones',
    ],
    sectors: [
      {
        title: 'Condomínios',
        icon: <Building2 />,
        description: 'Segurança total de áreas comuns.',
      },
      {
        title: 'Logística',
        icon: <Lock />,
        description: 'Controle de docas e estoque.',
      },
    ],
    applications: [
      {
        title: 'Reconhecimento de Placas',
        description: 'Controle automático de portões.',
      },
      {
        title: 'Análise de Perímetro',
        description: 'Linhas virtuais de invasão.',
      },
    ],
  },
  {
    ...
    description:
      'Organização de racks e cabeamento certificado para evitar quedas de rede.',
    items: [
      'Cat6 / Cat6a',
      'Organização de Rack',
      'Certificação Fluke',
    ...
    benefits: [
      'Identificação fácil de falhas',
      'Ambiente estético e profissional',
      'Máxima velocidade de transferência',
      'Documentação técnica de rede completa',
    ],
    technicalSpecs: [
      'Padrões TIA/EIA 568.C',
      'Materiais de Alta Performance',
      'Racks de 19 Polegadas',
      'Certificação com Relatório Técnico',
    ],
    workflow: [
      'Projeto de Lançamento e Topologia',
      'Instalação de Calhas e Dutos',
      'Identificação e Terminação',
      'Testes de Certificação Final',
    ],
    sectors: [
      {
        title: 'Indústria',
        icon: <Construction />,
        description: 'Redes fabris de alta resistência.',
      },
      {
        title: 'Educação',
        icon: <Globe />,
        description: 'Campus universitário cabeado.',
      },
    ],
    applications: [
      {
        title: 'Organização de Rack',
        description: 'Revitalização de CPDs antigos.',
      },
      {
        title: 'Backbone de Fibra',
        description: 'Conexão entre prédios e andares.',
      },
    ],
  },
  {
    ...
    description:
      'Internet rápida em todos os cômodos da casa, sem fios aparentes ou quedas.',
    items: [
      'Cobertura Total',
      'Rede Unificada',
      'Roaming Inteligente',
    ...
    sectors: [
      {
        title: 'Residencial',
        icon: <Home />,
        description: 'Casas e Apartamentos grandes.',
      },
      {
        title: 'Hotelaria',
        icon: <Wifi />,
        description: 'Cobertura total de hóspedes.',
      },
    ],
    applications: [
      {
        title: 'Gaming & Streaming',
        description: 'Zero lag em jogos e vídeos 8K.',
      },
      {
        title: 'Trabalho Mobile',
        description: 'Liberdade para reuniões em qualquer lugar.',
      },
    ],
  },
  {
    ...
    description:
      'Software de frente de caixa e gestão completa para pequenos e médios lojistas.',
    items: [
    ...
    fullDescription:
      'Organização e agilidade para o varejo regional. Nosso sistema PDV é homologado para as exigências fiscais do Ceará (SEFAZ-CE) e oferece uma interface simplificada que treina o operador em minutos. Com controle de estoque em tempo real e relatórios financeiros automáticos, o empresário tem o controle total do lucro na palma da mão.',
    benefits: [
      'Conformidade fiscal total (NFe/NFCe)',
      'Agilidade extrema no atendimento ao cliente',
      'Controle real de estoque e perdas',
      'Suporte técnico local imediato',
    ],
    technicalSpecs: [
      'Banco de Dados Local com Sincronia Cloud',
      'Compatível com Balanças e Scanners',
      'Módulo de Vendas Offline',
      'Relatórios de Performance de Vendas',
    ],
    workflow: [
      'Levantamento de Necessidades Fiscais',
      'Importação de Base de Produtos',
      'Instalação e Treinamento de Equipe',
      'Acompanhamento no Dia Um',
    ],
    sectors: [
      {
        title: 'Varejo Alimentar',
        icon: <Store />,
        description: 'Mercadinhos e Padarias.',
      },
      {
        title: 'Moda',
        icon: <ShoppingCart />,
        description: 'Lojas de roupas e calçados.',
      },
    ],
    applications: [
      {
        title: 'Venda Rápida',
        description: 'Interface otimizada para alto fluxo.',
      },
      {
        title: 'Gestão Cloud',
        description: 'Acesse dados de venda pelo celular.',
      },
    ],
  },
  {
    ...
    description:
      'Criação de sites, apps e sistemas customizados. O braço de inovação da FortalTech.',
    items: [
      'Sites & Landing Pages',
      'Apps iOS/Android',
      'Sistemas Web',
    ...
    sectors: [
      {
        title: 'Tecnologia',
        icon: <FlaskConical />,
        description: 'SaaS e Startups cearenses.',
      },
      {
        title: 'Governança',
        icon: <Zap />,
        description: 'Dashboards para tomada de decisão.',
      },
    ],
    applications: [
...
export const FAQ_ITEMS = [
  {
    ...
    answer:
      'Com certeza! Projetamos automação Smart Home para apartamentos novos ou já habitados, controlando luz, ar e som de forma discreta.',
  },
  {
    question: 'O A2insights Lab desenvolve qualquer tipo de software?',
    answer:
      'Focamos em sistemas web, apps mobile e dashboards de dados. Analisamos sua necessidade e criamos uma solução técnica viável e escalável.',
  },
  {
    question: 'Vocês atendem apenas Maracanaú?',
    answer:
      'Atendemos toda a RMF: Fortaleza, Maracanaú, Eusébio, Caucaia e demais cidades da Grande Fortaleza com equipe técnica presencial.',
  },
  {
    question: 'Como funciona o suporte técnico para empresas?',
    answer:
      'Oferecemos planos mensais que garantem visitas periódicas e atendimento prioritário para emergências, garantindo que sua empresa nunca pare por falha técnica.',
  },
];
