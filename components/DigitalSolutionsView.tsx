...
const DigitalSolutionsView: React.FC<DigitalSolutionsViewProps> = ({
  onNavigate,
}) => {
      ...
      <section className="bg-gradient-to-br from-[#0a1628] via-[#1a2b4b] to-[#395fa3] pt-40 pb-32 text-white relative overflow-hidden">
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-8xl font-black mb-10 leading-[0.85] tracking-tighter">
              CONECTANDO O <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#aa1a20] to-white/90">
                CAMPO AO DIGITAL.
              </span>
            </h1>
            <p className="text-xl md:text-2xl text-blue-100/60 leading-relaxed max-w-3xl mx-auto font-light">
              Do sensor na máquina ao dashboard no celular. Criamos a ponte que
              transforma infraestrutura física em dados inteligentes.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="bg-white p-12 rounded-[3.5rem] shadow-sm border border-gray-100">
              ...
              <h3 className="text-3xl font-black text-[#395fa3] mb-6 uppercase tracking-tighter">
                Web Apps de Controle
              </h3>
              <p className="text-gray-500 mb-10 leading-relaxed">
                Portais administrativos robustos para gestão de frotas e
              ...
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  >
                    <CheckCircle2 className="text-[#aa1a20] w-5 h-5 mr-3" />{' '}
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-[#0a1628] p-12 rounded-[3.5rem] shadow-2xl border border-white/5 lg:-translate-y-12 text-white">
              ...
              <p className="text-blue-100/50 mb-10 leading-relaxed">
                Aplicativos para equipes de campo com sincronização offline e
                geolocalização.
              </p>
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  <li
                    key={i}
                    className="flex items-center text-xs font-bold text-blue-100/80"
                  >
                    <CheckCircle2 className="text-[#aa1a20] w-5 h-5 mr-3" />{' '}
                    {item}
                  </li>
            ...
            <div className="bg-white p-12 rounded-[3.5rem] shadow-sm border border-gray-100">
              ...
              <p className="text-gray-500 mb-10 leading-relaxed">
                Tratamento de dados gerados pelos sensores e equipamentos
                instalados.
              </p>
              <ul className="space-y-4 mb-10">
                {[
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="lg:w-1/2">
              <div className="bg-white/5 border border-white/10 p-12 rounded-[4rem] backdrop-blur-xl">
                ...
                <p className="text-blue-100/70 text-lg leading-relaxed mb-10">
                  Nossa unidade de inovação é onde a mágica acontece.
                  Desenvolvemos a camada de inteligência que faz sua
                  infraestrutura pulsar.
                </p>
            ...
            <div className="lg:w-1/2 space-y-12">
              <h3 className="text-4xl md:text-6xl font-black text-white leading-tight">
                Codificamos a sua <br />
                <span className="text-[#aa1a20]">Vantagem Competitiva.</span>
              </h3>
              <a
                href="#contact"
      ...
      <section className="py-24 container mx-auto px-4 md:px-6">
        <div className="bg-gradient-to-r from-[#395fa3] to-[#1a2b4b] rounded-[4rem] p-12 md:p-24 text-white text-center shadow-2xl relative overflow-hidden">
          <h3 className="text-4xl md:text-6xl font-black mb-8 leading-tight">
            Quer transformar seus dados <br />
            em inteligência real?
          </h3>
          <button
            onClick={scrollToContact}
