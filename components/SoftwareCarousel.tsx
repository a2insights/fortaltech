        ...
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
          <div className="max-w-3xl">
            ...
            <p className="text-blue-100/60 text-lg mt-6 max-w-2xl leading-relaxed font-light">
              Codificamos a inteligência que escala sua operação. Do PDV ágil à
              automação de faturamento, entregamos o cérebro que sua
              infraestrutura física exige.
            </p>
          </div>
          ...
          {SOFTWARE_SYSTEMS.map((system, idx) => (
            ...
            >
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-10 rounded-[3rem] h-full flex flex-col hover:border-[#395fa3]/50 transition-all duration-500 hover:shadow-[0_0_50px_rgba(57,95,163,0.1)] relative overflow-hidden">
                ...
                <h3 className="text-2xl font-black text-white mb-4 group-hover:text-[#aa1a20] transition-colors">
                  {system.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-2 mb-10">
                  {system.tags.map((tag, i) => (
                    <span
                      key={i}
                      className="text-[9px] font-black uppercase tracking-widest bg-white/5 text-white/40 px-3 py-1.5 rounded-full border border-white/5"
                    >
                      {tag}
                    </span>
                  ))}
