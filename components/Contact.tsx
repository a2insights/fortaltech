      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <h3 className="text-4xl font-black text-[#395fa3] mb-8 leading-tight">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 max-w-xs uppercase text-sm">
                    Avenida Yolanda Pontes Vidal Queiroz, 57, Jereissati I,
                    Sala: 220, Edif: 1, Maracanaú - CE. CEP: 61.900-410
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gray-50 p-8 md:p-12 rounded-3xl shadow-xl border border-gray-100">
            <h4 className="text-2xl font-bold text-[#395fa3] mb-6">
              Envie sua mensagem
            </h4>
