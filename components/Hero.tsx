...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="home"
      className="relative h-[75vh] min-h-[600px] flex flex-col justify-center overflow-hidden bg-[#0a1628]"
    >
      {/* Background elements */}
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{
            backgroundImage: 'radial-gradient(#aa1a20 1px, transparent 1px)',
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="w-full lg:w-3/5 text-center lg:text-left">
            ...
            <p className="text-base md:text-xl text-blue-100/60 leading-relaxed mb-10 max-w-2xl font-light mx-auto lg:mx-0">
              ...
              e o poder do{' '}
              <span className="text-white font-bold">A2insights Lab</span> para
              transformar residências e empresas na Grande Fortaleza.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              >
                Explorar Soluções{' '}
                <ArrowRight className="inline ml-2 w-5 h-5 group-hover:translate-x-2 transition-transform" />
              </button>
          ...
          <div className="hidden lg:grid w-2/5 grid-cols-2 gap-4 animate-in fade-in slide-in-from-right duration-1000">
            <div
              className="bg-[#395fa3] p-6 rounded-[2rem] shadow-2xl border border-white/10 group hover:bg-[#aa1a20] transition-colors cursor-pointer"
              onClick={() => scrollToSection('services')}
            >
              <Home className="w-8 h-8 text-white mb-3" />
              <h4 className="text-sm font-black text-white mb-1 uppercase tracking-tighter">
                Automação Residencial
              </h4>
              <p className="text-blue-100/50 text-[8px] font-bold uppercase tracking-widest">
                Smart Homes RMF
              </p>
            </div>

            <div
              className="bg-[#0a1628] p-6 rounded-[2rem] shadow-2xl border-2 border-[#aa1a20]/50 group hover:border-white transition-all cursor-pointer"
            ...
            <div
              className="bg-[#aa1a20] p-6 rounded-[2rem] shadow-2xl border border-white/10 group hover:bg-[#395fa3] transition-colors cursor-pointer"
            ...
            >
              ...
              <p className="text-red-100/50 text-[8px] font-bold uppercase tracking-widest">
                Software sob medida
              </p>
            </div>

            <div
              className="bg-white p-6 rounded-[2rem] shadow-2xl group hover:shadow-[#aa1a20]/20 transition-all cursor-pointer"
              onClick={() => scrollToSection('contact')}
            >
              <Gauge className="w-8 h-8 text-[#aa1a20] mb-3" />
              <h4 className="text-sm font-black text-[#395fa3] mb-1 uppercase tracking-tighter">
                Telemetria & Suporte
              </h4>
