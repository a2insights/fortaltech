      ...
      <section className="bg-[#395fa3] pt-40 pb-24 text-white relative overflow-hidden">
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
          ...
          <p className="text-xl text-blue-50/70 leading-relaxed max-w-3xl mx-auto font-light">
            A FORTALTECH SOLUÇÕES TECNOLÓGICAS LTDA nasceu da paixão por
            inovação e do compromisso com a excelência técnica na Região
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2">
              <h2 className="text-3xl md:text-4xl font-black text-[#395fa3] mb-6">
                Expertise que gera confiança.
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                Fundada em Maracanaú, a FortalTech consolidou-se como referência
                em infraestrutura de TI e automação inteligente. Nossa jornada é
                marcada pela busca incessante por soluções que realmente
                simplificam a vida de nossos clientes, seja em ambientes
                residenciais de alto padrão ou em operações comerciais críticas.
              </p>
              <p className="text-gray-600 text-lg leading-relaxed mb-10">
                Acreditamos que a tecnologia deve ser invisível, porém
                onipresente, garantindo segurança, conforto e eficiência sem
                complicação.
              </p>
              <div className="grid grid-cols-2 gap-8">
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-blue-50 text-[#395fa3] rounded-2xl flex items-center justify-center font-black">
                    100%
                  </div>
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-red-50 text-[#aa1a20] rounded-2xl flex items-center justify-center font-black">
                    RMF
                  </div>
                  <span className="text-[10px] font-black uppercase text-gray-500 tracking-widest">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-12 rounded-[3rem] shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                Prover soluções tecnológicas inovadoras e de alta
                confiabilidade, integrando infraestrutura física e inteligência
                digital para impulsionar o sucesso de nossos parceiros e o
            ...
            <div className="bg-white p-12 rounded-[3rem] shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                Ser a maior e mais respeitada empresa de integração tecnológica
                do Ceará, reconhecida pela excelência de campo, agilidade no
                suporte e capacidade de inovação via nosso laboratório de
                software.
              </p>
            </div>
            ...
            <div className="bg-white p-12 rounded-[3rem] shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
              ...
              <ul className="space-y-2 text-gray-500 text-sm leading-relaxed">
                <li className="flex items-center">
                  <CheckCircle2 className="w-4 h-4 text-[#aa1a20] mr-2" /> Ética
                  e Transparência
                </li>
                <li className="flex items-center">
                  <CheckCircle2 className="w-4 h-4 text-[#aa1a20] mr-2" />{' '}
                  Inovação Constante
                </li>
                <li className="flex items-center">
                  <CheckCircle2 className="w-4 h-4 text-[#aa1a20] mr-2" /> Rigor
                  Técnico
                </li>
                <li className="flex items-center">
                  <CheckCircle2 className="w-4 h-4 text-[#aa1a20] mr-2" /> Foco
                  em Resultados
                </li>
              </ul>
            </div>
          ...
          <div className="bg-[#0a1628] rounded-[4rem] p-12 md:p-20 text-white flex flex-col lg:flex-row items-center gap-16 overflow-hidden relative">
            <div className="lg:w-1/2 relative z-10">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-sm uppercase tracking-widest text-white/50 mb-1">
                      Razão Social
                    </h4>
                    <p className="text-lg font-bold">
                      FORTALTECH SOLUCOES TECNOLOGICAS LTDA
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold">
                      Maracanaú - Ceará - Região Metropolitana
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:w-1/2 relative z-10 text-center lg:text-left">
              ...
              <p className="text-blue-100/60 mb-10 text-lg">
                Estamos sempre em busca de talentos técnicos e mentes
                inovadoras.
              </p>
              <button
