    ...
    <footer className="bg-[#1a2b4b] text-white pt-20 pb-10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-1">
            ...
            <p className="text-blue-100 text-sm leading-relaxed mb-6">
              Líderes em soluções de Automação Inteligente e Infraestrutura
              Técnica na Região Metropolitana de Fortaleza. Unidade Lab de
            ...
            <ul className="space-y-4 text-blue-100 text-sm font-medium">
              <li>
                <a
                  href="#"
                  onClick={(e) =>
                    handleLink(e, 'service-automacao-residencial-smart-home')
                  }
                  className="hover:text-[#aa1a20] transition-colors"
                >
              ...
              <li>
                <a
                  href="#"
                  onClick={(e) =>
                    handleLink(e, 'service-automacao-comercial-e-predial')
                  }
                  className="hover:text-[#aa1a20] transition-colors"
                >
                  Automação Predial
              ...
              <li>
                <a
                  href="#"
                  onClick={(e) =>
                    handleLink(e, 'service-seguranca-eletronica-cftv')
                  }
                  className="hover:text-[#aa1a20] transition-colors"
                >
                  Segurança & CFTV
              ...
              <li>
                <a
                  href="#"
                  onClick={(e) =>
                    handleLink(e, 'service-suporte-ti-empresarial')
                  }
                  className="hover:text-[#aa1a20] transition-colors"
                >
                  Suporte de TI Regional
                </a>
              </li>
              <li>
                <a
                  href="#"
                  onClick={(e) =>
                    handleLink(e, 'service-telemetria-e-rastreamento')
                  }
                  className="hover:text-[#aa1a20] transition-colors"
                >
                  Telemetria de Frotas
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-blue-100 text-sm font-medium">
              ...
              <li>
                <a
                  href="#"
                  onClick={(e) => handleLink(e, 'systems')}
                  className="hover:text-[#aa1a20] transition-colors"
                >
              ...
              <li>
                <a
                  href="#"
                  onClick={(e) => handleLink(e, 'consultancy')}
                  className="hover:text-[#aa1a20] transition-colors"
                >
                  Consultoria em TI
                </a>
              ...
              <li>
                <a
                  href="#"
                  onClick={(e) => handleLink(e, 'service-sistemas-pdv-varejo')}
                  className="hover:text-[#aa1a20] transition-colors"
                >
          ...
          <div>
            ...
            <ul className="space-y-4 text-blue-100 text-sm font-medium mb-6">
              ...
              <li>
                <a
                  href="#contact"
                  onClick={(e) => handleLink(e, 'home', '#contact')}
                  className="hover:text-[#aa1a20] transition-colors"
                >
                  Onde Atendemos
                </a>
            ...
            <p className="text-blue-200 text-[10px] font-bold opacity-60">
              AV. YOLANDA PONTES VIDAL QUEIROZ, 57
              <br />
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-[10px] font-bold uppercase tracking-widest text-blue-200/50">
          <p>
            © {new Date().getFullYear()} FortalTech Soluções Tecnológicas LTDA.
            Maracanaú, Ceará.
          </p>
