...
const Header: React.FC<HeaderProps> = ({ onNavigate, currentView }) => {
  ...
  return (
    <header
      className={`fixed w-full z-50 transition-colors duration-500 py-0 ${headerStyles}`}
    >
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between h-16 md:h-20">
        ...
        >
          ...
          <div className="flex flex-col">
            <span
              className={`text-xl font-extrabold leading-none transition-colors ${textColorClass}`}
            >
              FORTALTECH
            </span>
            <span
              className={`text-[10px] tracking-widest font-medium transition-colors ${subTextColorClass}`}
            >
              ...
              <div className="container mx-auto px-4">
                <div className="bg-white shadow-[0_60px_120px_rgba(0,0,0,0.18)] rounded-b-[4rem] overflow-hidden border border-gray-100 flex max-w-screen-2xl mx-auto min-h-[500px]">
                  ...
                  <div className="w-1/4 bg-gray-50 p-16 flex flex-col justify-center border-r border-gray-100">
                    ...
                    <h3 className="text-[#395fa3] font-black text-4xl mb-6 leading-[1.1] tracking-tighter">
                      Engenharia Digital
                    </h3>
                    <p className="text-gray-500 text-base leading-relaxed mb-12 italic opacity-80">
                      "A infraestrutura que move o Ceará, conectada à
                    ...
                    <div className="flex flex-col">
                      ...
                      >
                        ...
                        <p className="text-sm font-medium leading-relaxed transition-colors text-slate-500 group-hover:text-white/80">
                          Acesse o detalhamento completo de nossas soluções em
                          infraestrutura, automação e software para o biênio
                          2025-2026.
                        </p>
      ...
      >
        <div className="p-8 h-full overflow-y-auto">
          <div className="flex justify-between items-center mb-16">
            <span className="text-[#395fa3] text-2xl font-black tracking-tighter uppercase">
              FORTALTECH
            </span>
            <button
          ...
          <nav className="space-y-10 text-xl pb-16">
            ...
            <div className="bg-gray-50 p-8 rounded-[3rem] border border-gray-100">
              <span className="block text-gray-400 text-[11px] mb-8 uppercase tracking-[0.4em] font-black">
                Soluções Digitais
              </span>
              <div className="grid grid-cols-1 gap-8">
                {MEGA_MENU_PROJECTS.map((item, idx) => (
