          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <h2 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-[0.9] tracking-tighter">
                A2INSIGHTS:<br />
                <span className="text-[#aa1a20]">O CÉREBRO</span> DA<br />
                FORTALTECH.
              </h2>
              
              <p className="text-blue-100/60 text-lg md:text-xl leading-relaxed mb-12 max-w-xl font-light">
                Não apenas instalamos equipamentos; criamos a alma do seu negócio. O A2insights Lab desenvolve o software sob medida que transforma sua infraestrutura física em uma máquina de dados inteligente.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                >
                  Visitar o Lab <ExternalLink className="ml-3 w-5 h-5 group-hover:rotate-12 transition-transform" />
                </a>
            ...
            <div className="lg:w-1/2 relative">
              <div className="grid grid-cols-2 gap-6">
                {[
                  { icon: <Code2 className="w-8 h-8" />, label: "Full Stack Development", desc: "Sistemas Web e Apps Mobile nativos." },
                  { icon: <Database className="w-8 h-8" />, label: "Big Data & BI", desc: "Transformando logs em decisões." },
                  { icon: <Layers className="w-8 h-8" />, label: "Cloud & AWS", desc: "Infraestrutura escalável e segura." },
                  { icon: <Zap className="w-8 h-8" />, label: "High Performance", desc: "Código otimizado para escala global." }
                ].map((item, i) => (
                  <div key={i} className="bg-white/5 border border-white/5 p-8 rounded-[2.5rem] hover:bg-white/10 transition-all hover:-translate-y-2 group">
                    ...
                    <h4 className="text-white font-black text-sm uppercase tracking-tighter mb-2">{item.label}</h4>
