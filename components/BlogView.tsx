      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          <div className="inline-flex items-center space-x-2 text-[#aa1a20] mb-6 bg-red-50 px-4 py-1.5 rounded-full border border-red-100">
            ...
            <span className="font-black uppercase tracking-[0.2em] text-[10px]">FortalTech Insights</span>
          </div>
          ...
          <p className="text-gray-500 text-xl leading-relaxed max-w-2xl mx-auto font-light">
            Explorando mais de 500 tópicos técnicos para transformar a infraestrutura tecnológica do seu negócio na RMF.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          {selectedCategory && (
            <div className="mt-6 flex items-center justify-center space-x-3 animate-in fade-in slide-in-from-top-2">
              <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Filtrando por:</span>
              <div className="bg-[#aa1a20] text-white px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest flex items-center shadow-lg shadow-red-900/10">
                {selectedCategory}
                <button onClick={() => setSelectedCategory(null)} className="ml-2 hover:scale-110 transition-transform">
              ...
              <AnimatePresence mode='popLayout'>
                {visiblePosts.length > 0 ? (
                  ...
                  <div className="col-span-full py-24 text-center">
                    ...
                    <h3 className="text-2xl font-black text-gray-300 uppercase tracking-tighter">Nenhum artigo encontrado</h3>
                    <p className="text-gray-400 mt-2">Tente pesquisar por outros termos ou categorias.</p>
                  </div>
                )}
              </AnimatePresence>
            </div>
            ...
            {!hasMore && allFilteredPosts.length > 0 && (
              <div className="py-20 text-center">
                 <div className="inline-flex items-center space-x-3 text-gray-300">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest">Fim dos resultados para esta categoria</span>
                    <div className="h-[1px] w-12 bg-gray-100"></div>
                 </div>
              </div>
            )}
          ...
          <aside className="lg:w-1/4 space-y-12">
            ...
            <div className="bg-[#395fa3] p-10 rounded-[3rem] text-white shadow-xl relative overflow-hidden group">
               <div className="relative z-10">
                 <h4 className="text-4xl font-black mb-2 leading-none">+{BLOG_POSTS.length}</h4>
                 <p className="text-blue-100/60 text-[10px] font-black uppercase tracking-widest mb-6">Conteúdos Publicados</p>
                 ...
                 <p className="text-xs font-bold leading-relaxed opacity-80">A maior biblioteca técnica de infraestrutura e automação da RMF.</p>
               </div>
            ...
            <div className="bg-[#0a1628] p-10 rounded-[3rem] text-white relative overflow-hidden group">
               <div className="relative z-10">
                 <h4 className="text-xl font-black mb-4 leading-tight">Inovação no seu E-mail</h4>
                 <p className="text-blue-100/50 text-xs leading-relaxed mb-8">Receba os melhores insights técnicos do Ceará mensalmente.</p>
                 <div className="space-y-3">
                    <input type="email" placeholder="Seu melhor e-mail" className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:bg-white/10 transition-all" />
                    <button className="w-full bg-[#aa1a20] text-white py-4 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-white hover:text-[#0a1628] transition-all">Assinar</button>
                 </div>
               </div>
            </div>
          </aside>
